module MBWS
  ...
  class Artist < Resource
    ...
    def aliases
      ...
      artist_xml = Request.get("artist/#{mid}", inc: 'aliases')
    ...
    def releases
      ...
      @releases = Release.find(artistid: mid, inc: 'counts', limit: 100)
    end

    #
    def releases_find(options = {})
      options.merge!(artistid: mid, inc: 'counts')
    ...
    def _inc_releases(prefix, options)
      ...
      releases = []
      xml = Request.get("artist/#{mid}", inc: inc)
